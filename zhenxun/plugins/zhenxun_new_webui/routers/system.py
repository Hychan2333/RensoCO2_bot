...
router = WebUIRouter(prefix="/system", tags=["系统"])
...
@router.get(
    "/health", response_model=APIResponse[SystemHealth], summary="获取系统健康状态"
)
...
@router.get(
    "/bot-status", response_model=APIResponse[BotStatus], summary="获取 Bot 状态"
)
